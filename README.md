# blakewmorrisuk.github.io

Personal landing page for Blake Morris at <https://blakewmorrisuk.github.io/>.

Plain static HTML + CSS. No build step. Push to `main` and GitHub Pages publishes within ~30 seconds.

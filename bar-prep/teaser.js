(function () {
    ...
    function spawnConfetti(originX, originY) {
        ...
        for (let i = 0; i < 22; i++) {
            ...
            const dxEnd = Math.cos(angle) * speed;
            const dyArc = Math.sin(angle) * speed;
            const dyEnd = dyArc + 70 + Math.random() * 70;
            ...
            p.style.setProperty("--dx-mid", (dxEnd * 0.45).toFixed(1) + "px");
            p.style.setProperty("--dy-mid", dyArc.toFixed(1) + "px");
            p.style.setProperty("--dx-end", dxEnd.toFixed(1) + "px");
            p.style.setProperty("--dy-end", dyEnd.toFixed(1) + "px");
